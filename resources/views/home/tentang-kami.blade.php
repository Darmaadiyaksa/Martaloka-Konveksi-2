                    ...
                    <div class="intro-style2-text-box">
                        ...
                        <div class="intro-style2-text-box__inner">
                            <div class="top-justify">
                                <p> Martaloka Konveksi ini ialah usaha konveksi seperti pada 
                                    ...
                                    Desa Banjar Tegeha, Kecamatan Banjar,Kabupaten Buleleng.</p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="about-style1-content">
                                    <div class="inner-tile" style="margin-top: -40px;">
                                        <h3>Proses Produksi<br>.</h3>
                                     </div>
                                    <div class="top">
                                        <div class="text-justify">
                                            <p>Di Martaloka Konveksi, setiap tahap produksi dilakukan dengan fokus pada kualitas dan ketelitian. 
                                                Proses dimulai dengan pemilihan bahan berkualitas yang diperiksa dengan cermat untuk memastikan 
                                                ketahanan dan kenyamanan. Setelah itu, tim ahli kami membuat pola presisi sesuai desain, yang 
                                                kemudian diterapkan pada bahan dan dipotong menggunakan teknologi canggih untuk menjaga konsistensi.
                                                Proses jahit dilakukan oleh penjahit berpengalaman, dengan memastikan setiap jahitan kuat dan rapi, 
                                                sehingga produk yang dihasilkan kokoh serta nyaman dipakai.
                                                </p>
                                        </div>
                                    </div>
                                    <div class="text-justify">
                                        <p>Setelah penjahitan selesai, produk melewati pemeriksaan kualitas menyeluruh untuk memastikan tidak ada cacat produksi.
                                            Produk yang lolos pemeriksaan akan disetrika dan menjalani tahap finishing agar tampil sempurna. Setelah itu, produk
                                            dikemas dengan rapi menggunakan bahan kemasan yang aman untuk menjaga kualitas selama pengiriman. Dengan bekerja sama
                                            dengan jasa pengiriman terpercaya, kami memastikan produk sampai tepat waktu dan dalam kondisi prima. Martaloka
                                            Konveksi selalu berkomitmen untuk memberikan hasil yang memenuhi harapan pelanggan.</p>
                                    </div>
                                    <div class="accreditations-logo">
                                        <ul>
                                            <li>
                                                <div class="single-accreditations-logo">
                                                    <img src="assets/images/bungkus.jpg"
                                                        alt="">
                                                </div>
                                            </li>
                                        </ul>
                            ...
                            <div class="col-xl-6">
                                <div class="about-style1-img-box">
                                    <div class="inner">
                                        ...
                                        <img src="assets/images/sablon.png" alt="" style="margin-top: 130px;">
                                    </div>
                                </div>
                            </div>
